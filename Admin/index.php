              ...
              <div class="card">
                <div class="card-body">
                  <div class="media">
                    ...
                    <div class="media-middle media-body">
                      <h6 class="media-heading">User download</h6>
                      <h3 class="media-heading">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="media">
                    ...
                    <div class="media-middle media-body">
                      <h6 class="media-heading">Publisher download</h6>
                      <h3 class="media-heading">
                        <span class="fw-l">2347</span>
                      </h3>
                    </div>
                  </div>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="media">
                    ...
                    <div class="media-middle media-body">
                      <h6 class="media-heading">Total Subscribe</h6>
                      <h3 class="media-heading">
                        <span class="fw-l">3527</span>
                      </h3>
                    </div>
                  </div>
                </div>
